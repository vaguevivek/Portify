                ...
                <nav className="hidden md:flex items-center justify-center space-x-8">
                    {navItems.map(item => (
                        <a 
                            ...
                            className="text-gray-600 hover:text-indigo-600 transition-colors duration-300 font-medium whitespace-nowrap"
                        >
                            {item}
                        </a>
                    ))}
